...
#ifndef __LUCI_IR_CIRCLEMAXPOOLWITHARGMAX_H__
#define __LUCI_IR_CIRCLEMAXPOOLWITHARGMAX_H__
...
public:
  ...
  bool include_batch_in_index(void) const { return _include_batch_in_index; }
  void include_batch_in_index(bool ibii) { _include_batch_in_index = ibii; }
...
private:
  ...
  bool _include_batch_in_index = false;
};

} // namespace luci

#endif // __LUCI_IR_CIRCLEMAXPOOLWITHARGMAX_H__
